...
describe('SetRepeatStrategy', () => {
  let repeat, strategy, viewSlot, viewFactory, component;
  ...
  describe('instanceMutated', () => {
    ...
    it('should correctly handle adding item (i.e Set.prototype.add())', () => {
      repeat = new Repeat(new ViewFactoryMock(), instructionMock, viewSlot, viewResourcesMock, new ObserverLocator(), undefined);
      let bindingContext = {};
    ...
    it('should correctly handle deleting item (i.e Set.prototype.delete())', () => {
      ...
      repeat = new Repeat(new ViewFactoryMock(), instructionMock, viewSlotMock, viewResourcesMock, new ObserverLocator(), undefined);
      let bindingContext = {};
      repeat.scope = { bindingContext, overrideContext: createOverrideContext(bindingContext) };
      records = [{
        type: 'delete',
